...
import com.profile.app.JwtUtil;
...
public class ProfileController {
	...
	public UserProfile getByProfileId(@PathVariable("userId") int userId) {
		logger.trace("Get profile by ID method accessed");
		
		UserProfile userProfile = profileServiceImpl.getByProfileId(userId);
		return userProfile;
	}
