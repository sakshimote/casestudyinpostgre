...
import com.product.app.JwtUtil;
...
public class ProductController {
	...
	public Product addProduct(@RequestBody Product product ,@PathVariable ("merchantId") int merchantId,
	...
	public List<Product> getProductByCategoryId(@PathVariable("categoryId") int categoryId) {
	...
	public List<Product> getProductsByMerchantId(@PathVariable("merchantId") int merchantId){
